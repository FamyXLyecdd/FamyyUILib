...
-- The library comes pre-initialized with a Window from the embedded code (at the end of Library code above)
-- We need to access that existing window to add our showcase tabs to it
local Window = Library.Window

-- If for some reason Window is nil (e.g. library structure changed), create a new one, but the above code ensures it exists
if not Window then
