...
local Sea2Locations = {
    {name = "Kingdom of Rose", pos = CFrame.new(-379.531, 73.006, 296.681)},
    {name = "Usoap Island", pos = CFrame.new(2284.012, 15.006, 870.252)},
    {name = "Mansion", pos = CFrame.new(-379.531, 73.006, 296.681)},
    {name = "Green Zone", pos = CFrame.new(-2805.702, 72.252, -6829.072)},
    {name = "Graveyard", pos = CFrame.new(-5116.652, 22.052, -5239.102)},
    {name = "Snow Mountain", pos = CFrame.new(6133.802, 132.772, -5052.052)},
    {name = "Hot and Cold", pos = CFrame.new(-6217.202, 28.047, -5053.135)},
    {name = "Cursed Ship", pos = CFrame.new(916.022, 184.092, 33430.172)},
    {name = "Ice Castle", pos = CFrame.new(-3040.212, 308.692, -10133.872)},
    {name = "Forgotten Island", pos = CFrame.new(3880.832, 37.152, -1986.922)},
    {name = "Dark Arena", pos = CFrame.new(-379.531, 73.006, 296.681)},
    {name = "Cafe", pos = CFrame.new(-379.531, 73.006, 296.681)},
    {name = "Volcano", pos = CFrame.new(-5351.642, 312.096, 8863.992)},
}
...
local Sea3Locations = {} -- Removed for Sea 2 Script
...
-- Sea 1 TP Tab Removed for Sea 2

-- ============================================================================
-- UI - SEA 2 TP TAB
-- ============================================================================

local Sea2TPTab = Window:CreateTab("Sea 2 TP")
local Sea2TPSection = Sea2TPTab:CreateSection("Sea 2 Teleports", true)

for _, loc in ipairs(Sea2Locations) do
    Sea2TPSection:AddButton({
        Label = loc.name,
        Callback = function()
            Tween(loc.pos)
        end
...
-- Sea 3 TP Tab Removed for Sea 2
...
local NPCDatabase = {
    ...
    -- Sea 3 NPCs
    -- Sea 3 NPCs removed for Sea 2 Script
}
...
local BossDatabase = {
    ...
    -- Sea 3 Bosses
    -- Sea 3 Bosses removed for Sea 2 Script
}
